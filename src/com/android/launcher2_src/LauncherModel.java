...
import com.android.launcher2_src.InstallWidgetReceiver.WidgetMimeTypeHandlerData;
        ...
        private void loadAllAppsByBatch() {
            ...
            while (i < N && !mStopped) {
                ...
                for (int j=0; i<N && j<batchSize; j++) {
                    ...
                    //Log.d( TAG, "apps.get(i) = " + apps.get(i) );
                    //Log.d( TAG, "mIconCache = " + mIconCache );
                    //Log.d( TAG, "mLabelCache = " + mLabelCache );
                    i++;
                }
