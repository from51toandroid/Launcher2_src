...
package com.android.launcher2_src;
...
import com.android.launcher_src.R;
import com.android.launcher2_src.DropTarget.DragObject;
...
public final class Launcher extends Activity
    ...
    static final String TAG = "Launcher_src";
    ...
    private void startTimer_boostUperf(){
		...
		//Log.d( TAG, "mKeyguardManager = " + mKeyguardManager );
		//Log.d( TAG, "mKeyguardManager.isKeyguardLocked() = " + mKeyguardManager.isKeyguardLocked() );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SystemProperties.set("sys.enter_launcher_src", "1");
    ...
    */
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        //Log.d( TAG, "isAllAppsVisible() = " + isAllAppsVisible() );
        if( event.getScanCode()==186 && isAllAppsVisible()==false ){
            //Activity activity = getActivity();
            //activity.setResult(Activity.RESULT_OK);
            SystemProperties.set("sys.enter_launcher_src", "0");
            this.finish();
		   android.os.Process.killProcess(android.os.Process.myPid());
        }

        if( event.getScanCode()==185 && isAllAppsVisible()==false ){
            //Activity activity = getActivity();
            //activity.setResult(Activity.RESULT_OK);
            SystemProperties.set("sys.enter_launcher_src", "0");
            this.finish();
    ...
    public void startActivityForResult(Intent intent, int requestCode) {
        //Log.i(TAG, "\n" + this, new RuntimeException("run stack is:").fillInStackTrace() );
...
//        }
	...
	//Log.d(TAG, "in onBackPressed");
        if (isAllAppsVisible()) {
		   Log.d(TAG, "in onBackPressed1");	
            showWorkspace(true);
        } else if (mWorkspace.getOpenFolder() != null) {
            Log.d(TAG, "in onBackPressed2");
            Folder openFolder = mWorkspace.getOpenFolder();
    ...
    public static void dumpDebugRunStack() {
        RuntimeException e = new RuntimeException("error is here");
        e.fillInStackTrace();
        Log.e( TAG, "dumpDebugRunStack:", e);
    }
